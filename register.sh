...
http POST http://paas:6000/bigdata/api/v1/products name=postgis version=12.6 description='Postgresql + Postgis & Timescaledb. Postgresql with the most common extensions for spatial data and time series' logo_url='http://bigdata.cesga.es/img/pgsql_sp-tmp_logo_transparent.png' x-auth-token:$TOKEN
