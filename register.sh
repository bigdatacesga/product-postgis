...
http POST http://paas:6000/bigdata/api/v1/products name=postgis version=25_12_BETA description='BETA VERSION Postgresql with the most common extension for spatial data' logo_url='http://bigdata.cesga.es/img/postgis_logo_BETA.gif' x-auth-token:$TOKEN
